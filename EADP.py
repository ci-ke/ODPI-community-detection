...
def run_linux_generate_picture(steps=5, new_makdir="test"):
    ...
    result_image_path = "./result_images/" + new_makdir
...
def deal_contrast_generate_table(new_makdir, steps):
    ...
    file_path = "./result_images/" + new_makdir + "/{}.txt".format(new_makdir)
    if os.path.exists(file_path):
        os.remove(file_path)
...
def run_true_datasets():
    ...
    need_update_path(None, "./result_images/true_datasets")
...
def run_test_dc_for_true_dataset():
    ...
    result_image_path = "./result_images/test_dc_for_true/"
...
def run_test_dc_for_lfr():
    ...
    result_image_path = "./result_images/test_dc_for_lfr/"
...
def run_test_u_for_lfr():
    ...
    result_image_path = "./result_images/test_u_for_lfr/"
...
def run_test_c_for_lfr():
    ...
    result_image_path = "./result_images/test_c_for_lfr/"
...
if __name__ == '__main__':
    # global path
    run_all_true_dataset = True  # 表示自动化运行所有的真实数据集
